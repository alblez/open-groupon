...
if (!file_exists($autoload)) {
    throw new RuntimeException('Antes de ejecutar los tests de esta application, instala sus dependencias mediante el comando "composer install"');
}
...
// Si existe, borrar el file con los datos de prueba de la base de datos
